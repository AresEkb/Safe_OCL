...
lemma subtype_Tuple_x_intro' [intro]:
  "\<sigma> = Tuple \<xi> \<Longrightarrow> \<xi> \<noteq> [] \<Longrightarrow> length \<pi> \<ge> length \<xi> \<Longrightarrow> list_all2 (\<le>) \<pi> \<xi> \<Longrightarrow> Tuple \<pi> \<le> \<sigma>"
