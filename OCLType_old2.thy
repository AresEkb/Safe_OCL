...
lemma subtype_OclInvalid_x [elim]:
  "direct_subtype\<^sup>+\<^sup>+ OclInvalid \<sigma> \<Longrightarrow>
   ...
   (\<exists>\<rho>. \<sigma> = \<rho>[1] \<Longrightarrow> P) \<Longrightarrow>
   (\<exists>\<rho>. \<sigma> = \<rho>[?] \<Longrightarrow> P) \<Longrightarrow>
...
lemma subtype_x_Required':
  "direct_subtype\<^sup>+\<^sup>+ \<tau> \<sigma>[1] \<Longrightarrow>
   ...
   (\<exists>\<rho>. \<tau> = \<rho>[1] \<Longrightarrow> P) \<Longrightarrow> P"
